...
\begin{itemize}
  ...
  \item for \tcode{T} reflecting all other \grammarterm{simple-type-specifiers}, the name stated in the "Type" column of Table \cxxref{tref:simple.type.specifiers} in (\cxxref{dcl.type.simple});
