...
\pnum
Conformance requirements for this document are those defined in ISO/IEC 14882:2020, \ref{general.compliance}. Similarly, all references to ISO/IEC 14882:2020 in the resulting document shall be taken as referring to the resulting document itself.
\begin{note}
