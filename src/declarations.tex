...
\pnum
Note A: For a parenthesized expression \tcode{(E)}, whether or not itself nested inside a parenthesized expression, the expression \tcode{E} shall be either a parenthesized expression, a \grammarterm{function-call-expression}, or a \grammarterm{functional-type-conv-expression}; otherwise the program is ill-formed.
