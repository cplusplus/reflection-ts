...
\begin{std.txt}\color{addclr}
    ...
    type is an incomplete namespace-scope class type (Clause \cxxref{class}).
    ...
    \begin{itemize}
      ...
      \item \tcode{A} is the return type, a parameter type, or function type of the function \tcode{B}, or
...
\added{value}       & \added{the name of a variable or structured binding}                            & \added{\tcode{reflect::Variable}}        \\
            ...
            & \added{the name of a captured entity (\ref{expr.prim.lambda.capture})} & \added{\tcode{reflect::LambdaCapture}} \\
\bottomline
\end{floattable}
