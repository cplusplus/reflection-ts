...
\added{Expression} & \added{the name of a data member}                                               & \added{\tcode{reflect::Variable}} \\ \cline{2-3}
            ...
            & \added{\grammarterm{functional-type-conv-expression\normalfont\textsubscript{1}}}        & \added{\tcode{reflect::FunctionalTypeConversion}} \\ \capsep

\multicolumn{3}{|l|}{\added{\hspace{.1in}NOTE 1\hspace{.1in}
...
\pnum
TODO. Remove paragraph. Kept only for number keeping.
...
unevaluated operand (\cxxref{expr}).  If the
