...
\pnum
In {\cppstddocno} [expr.prim.lambda], apply the following change to the second bullet in paragraph \cxxref{expr.prim.lambda.paragraph0}:
...
\pnum
In {\cppstddocno} [expr.post], apply the following change:
...
For Statements, {\cppstddocno}, Clause \the\value{chapter} shall be used.
